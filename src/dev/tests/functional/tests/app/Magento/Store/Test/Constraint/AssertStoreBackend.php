 ...
 * Assert that created store view displays in backend configuration (Stores > Configuration > "Scopes" dropdown)
 */
class AssertStoreBackend extends AbstractConstraint
{
    ...
    {
        return 'Store View is available in backend configuration (Stores > Configuration > "Scopes" dropdown)';
    }
}
